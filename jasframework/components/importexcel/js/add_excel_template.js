...
function checkNameOrCode() {
    var bool = false;
    $.ajax({
        url: addTokenForUrl(rootPath + '/jasframework/excelTemplate/checkNameOrCodeExist.do'),
        type: 'post',
        dataType: 'json',
        async: false,
        data: {
...
function save() {
    ...
    if (bool) {
        $.ajax({
            url: rootPath + '/jasframework/excelTemplate/save.do',
            type: 'post',
            dataType: 'json',
            async: false,
