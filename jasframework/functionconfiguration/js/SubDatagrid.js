...
(function($) {
	/**
     * 方法描述：定义从表datagrid网格类并初始化类中的属性和方法。
     */
	$.jasfcFactory( "jasfc.SubDatagrid", {
		options: {
			functionName:'',
			functionData:null,
			divid:''
		...
		loadGridfield : function(){
			...
			var queryParam ={"functionName":functionName,subFieldName:subIdField,masterFieldValue:subeventid};
...
//				title:title,
				...
				onDblClickRow:function(index, row){
				    ...
				    var url ="subDetail.htm?functionName="+ functionName + "&pkfield="+pkfield+"&businessDataId=" + encodeURI(encodeURI(businessDataIds)) ;
