		...
		onDblClickRow: function (index, indexData) {
			...
			if (typeFlag == 1) {
				...
				// if (indexData.preview == 1) {
					Preview(indexData.filetype,eventid);
				// } else {
...
function updateFolder(folderId) {
	...
	getDlg("updateFavorite.htm?folderId=" + folderEventId, 'updateFolder', "收藏夹修改", 450, 170);
}
/**
 * 方法描述：删除文件夹
 */
 ...
 *	@param eventid	选中记录的eventid
 */
function Preview(fileType,eventid, versionid) {
	$.ajax({
