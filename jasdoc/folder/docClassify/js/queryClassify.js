...
function addToFavorite() {
	...
	if (rows.length > 0) {
		...
		getDlg("../favorite/addToFavorite.htm?eventids=" + eventids + "&filenames=" + encodeURIComponent(encodeURIComponent(filenames)) + "&foldertype=" + foldertype + "&folderid=" + folderId + "&r=" + new Date().getTime(), 'favorite', '添加收藏', 580,300);
